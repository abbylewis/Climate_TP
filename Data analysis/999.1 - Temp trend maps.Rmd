...
all_trends <- climate_narr_trends%>%
  ...
  mutate(Month = factor(Month, 
                        levels = unique(Month), 
                        labels = month.name[unique(Month)],
                        ordered = T))
