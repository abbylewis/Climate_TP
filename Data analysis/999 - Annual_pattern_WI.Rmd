...
```{r}
#summer_do_points = read.csv("../../results/summary dataframes/summer_do_points.csv")
#summer_doc_points = read.csv("../../results/summary dataframes/summer_doc_points.csv")
#summer_p_points = read.csv("../../results/summary dataframes/summer_p_points.csv")
#summer_chla_points = read.csv("../../results/summary dataframes/summer_chla_points.csv")
...
library(MASS)
jpeg("../../results/figures/WI/DO and temp by month.jpg", width = 6, height = 4, res = 300, units = "in")
...
jpeg("../../results/figures/WI/DO and temp by month_lines.jpg", width = 6, height = 4, res = 300, units = "in")
do_temp_data = many_lake_stat%>%
  group_by(mon)%>%
  mutate(p = wilcox.test(do_temp)$p.value,
         n = n(),
