...
do_temp_era5 <- plot_monthly_correlation(with_temp,"ERA5")
temp_temp_era5 <- plot_monthly_correlation_hypo_temp(with_temp,"ERA5")
do_temp_era5_map <- plot_monthly_correlation_map(with_temp,"ERA5")
do_temp_jra55 <- plot_monthly_correlation(with_temp,"JRA55")
temp_temp_jra55 <- plot_monthly_correlation_hypo_temp(with_temp,"JRA55")
do_temp_jra55_map <- plot_monthly_correlation_map(with_temp,"JRA55")
do_temp_narr <- plot_monthly_correlation(with_temp,"NARR")
temp_temp_narr <- plot_monthly_correlation_hypo_temp(with_temp,"NARR")
do_temp_narr_map <- plot_monthly_correlation_map(with_temp,"NARR")
